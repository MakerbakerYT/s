...
class Scoreboards extends PluginBase{
    ...
    public function remove(Player $player) : void{
        ...
        unset($this->lines[$player->getName()]);
    }
    ...
    public function setLine(Player $player, int $score, string $message) : void{
        ...
        if(isset($this->lines[$player->getName()][$score])){
        ...
        $pk->entries[] = $entry;
        $player->sendDataPacket($pk);
        $this->lines[$player->getName()][$score] = $message;
    }
    ...
    public function getLines(Player $player) : array{
        return $this->lines[$player->getName()];
    }
}